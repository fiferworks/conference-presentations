...
# Rose Rosette Disease continues to kill our roses
...
# *P. fructiphilius* are moving southwards into Florida
```{r survey-map-1, cache = TRUE, cache.extra = file.mtime('figure/rrv_survey_map_fl_pf.png'), fig.pos = 'p', fig.cap = "*P. fructiphilus* mites recovered during surveys of roses in Florida, 2017-2021.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_fl_pf.png')
```
- Check out @Monterrosa2021

# Plant defenses slow the progress of RRD infection



<!-- # Phytoseiids an option for control? -->
<!-- - Too large! -->
<!-- - Model organism? -->


<!-- - Preliminary research: *Amblyseius swirskii* RRD-infected roses -->
